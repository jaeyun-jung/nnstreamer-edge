 ...
 * @remarks The handle is left untouched if @a data is not a valid serialized edge data.
 * Otherwise the previous raw data is released, and the handle holds no raw data when the deserialization fails.
 * @param[in] data_h The handle to the edge data.
